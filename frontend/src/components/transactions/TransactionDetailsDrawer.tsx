  ...
  return (
    ...
    >
      <div className="space-y-4">
        ...
        <div className="text-center p-4 sm:p-5 bg-slate-950/80 rounded-2xl border border-slate-800/80">
          <div className="w-10 h-10 mx-auto rounded-xl bg-blue-600/10 border border-blue-500/20 text-blue-400 flex items-center justify-center mb-2">
            <CreditCard className="w-5 h-5 stroke-[2]" />
          </div>
          <h2 className="text-lg font-bold text-slate-100">{transaction.merchant}</h2>
          <div className="text-2xl sm:text-3xl font-extrabold text-white mt-0.5">
            {formatCurrency(transaction.amount, transaction.currency)}
          </div>
          <div className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold border mt-2.5 ${currentStatus.bg}`}>
        ...
        {isSuccess && earnedCoins > 0 && (
          <div className="flex items-center gap-3 p-3.5 bg-gradient-to-r from-amber-500/10 to-yellow-500/5 border border-amber-500/30 rounded-xl text-amber-300">
            <div className="p-2 rounded-lg bg-amber-500/20 text-amber-400">
              <Gift className="w-4 h-4" />
            </div>
            <div>
              <p className="text-[11px] font-semibold text-amber-400 uppercase tracking-wider">Rewards Earned</p>
              <p className="text-xs sm:text-sm font-bold text-white">
                +{earnedCoins} CoinFlow Reward Coins <span className="text-[11px] font-normal text-amber-300/80">(₹100 = 1 coin)</span>
              </p>
            </div>
          </div>
        )}
        ...
        <div className="grid grid-cols-2 gap-3 text-xs">
          <div className="p-2.5 bg-slate-950/40 rounded-xl border border-slate-800/60">
            <span className="text-slate-400 flex items-center gap-1 mb-1 font-medium text-[11px]">
          ...
          <div className="p-2.5 bg-slate-950/40 rounded-xl border border-slate-800/60 col-span-2 sm:col-span-1">
            <span className="text-slate-400 flex items-center gap-1 mb-1 font-medium text-[11px]">
          ...
          <div className="p-2.5 bg-slate-950/40 rounded-xl border border-slate-800/60 col-span-2 sm:col-span-1">
            ...
            <span className="text-[11px] font-mono font-semibold text-slate-300 break-all">
              {transaction.id}
            </span>
          </div>
        </div>
